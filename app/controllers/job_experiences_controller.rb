class JobExperiencesController < ApplicationController
  ...
  private
    ...
    def job_experience_params
      params.require(:job_experience).permit(:company_name, :company_address, :company_phone, :job_title, :start_date, :end_date, :job_description, :reason_of_resignation, :profile_id)
    end
end
