...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { certificate: @training.certificate, location: @training.location, name: @training.name, notes: @training.notes, organizer: @training.organizer, profile_id: @training.profile_id, year: @training.year } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { certificate: @training.certificate, location: @training.location, name: @training.name, notes: @training.notes, organizer: @training.organizer, profile_id: @training.profile_id, year: @training.year } }
