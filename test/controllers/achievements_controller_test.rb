...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { name: @achievement.name, notes: @achievement.notes, profile_id: @achievement.profile_id } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { name: @achievement.name, notes: @achievement.notes, profile_id: @achievement.profile_id } }
